"""unicorn_world_20267 URL Configuration
...
admin.site.site_header = "unicorn world"
admin.site.site_title = "unicorn world Admin Portal"
admin.site.index_title = "unicorn world Admin"

# swagger
api_info = openapi.Info(
    title="unicorn world API",
    default_version="v1",
    description="API documentation for unicorn world App",
)
